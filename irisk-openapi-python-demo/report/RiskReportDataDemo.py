...
class RiskReportDataDemo(object):
    """本接口用于上报应用的举报信息。"""

    API_URL = "http://ir-open.dun.163.com/v5/risk/reportData"
...
if __name__ == "__main__":
    ...
    VERSION = "500"
    api = RiskReportDataDemo(SECRET_ID, SECRET_KEY, BUSINESS_ID, VERSION)
    ...
    # 举报时间
    params['reportTime'] = int(time.time() * 1000)
    # 举报人信息
    whistleblower_map = {
        'account': 'account01',
        'roleId': 'roleId01',
    ...
    params['whistleblower'] = json.dumps(whistleblower_map)
    # 被举报人信息
    reported_person = {
        'account': 'account02',
        'roleId': 'roleId02',
    ...
    params['reportedPerson'] = json.dumps(reported_person)
    # 举报类型
