...
const (
	apiUrl     = "http://ir-open.dun.163.com/v4/risk/detail" //接口url
	secretId   = "your_secretk_id"          //产品id，每个应用接入时，会分配secretId和私钥secretKey。
	secretKey  = "4817728b19fb48c6aab9f3943be98491"          //产品密钥，每个应用接入时，会分配secretId和私钥secretKey。
	businessId = "0411475aac5b3d59d004420c1021bbe3"          //每个业务接入时，均会分配业务 ID，有对应的密钥 secretId。
